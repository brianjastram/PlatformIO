...
const char *sketchName = "RG03CtoF.cpp";
...
// CtoF - example from the internet
float CtoF(float celcius)
{
  float fahrenheit = (celcius * 1.8) + 32;
  return fahrenheit;
}
// End CtoF - example from internet
// Properties of the calculated temperature variable
const char *TempFVarName = "Temperature";
const char *TempFVarUnit = "DegreesFahrenheit";
int TempFVarResolution = 1;
...
// Create the function to convert the SHT4X celcius to fahrenheit
float calculatesht4xTempF(void)
{
    float TempCFromsht4x = sht4xTemp->getValue();
    if (TempCFromsht4x == -9999.0) {
        // If the temperature reading failed, return -9999.0
        return -9999.0;
    } else {
        // Otherwise, convert the temperature to Fahrenheit and return it
        float tempF = CtoF(TempCFromsht4x);
        return tempF;
    }
}
const char *sht4xTempFUUID = "7b1df8a7-9115-462f-a802-85b7b04b8c21";
const char *sht4xTempFVarCode = "sht4xTempF";
// Create the calculated fahrenheit variable object and return a variable pointer to it
Variable *sht4xTempF = new Variable(calculatesht4xTempF, TempFVarResolution,
                                     TempFVarName, TempFVarUnit,
                                     sht4xTempFVarCode, sht4xTempFUUID);
...
Variable* variableList[] = {
    ...
    sht4xTempF,         // Temperature (Sensirion_SHT40_TemperatureF)
};
