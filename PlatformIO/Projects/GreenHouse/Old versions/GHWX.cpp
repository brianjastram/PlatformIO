...
// C to F - example from the internet
float CtoF(float cel)
{
  float fahrenheit = (cel * 1.8) + 32;
  return fahrenheit;
}
...
Variable *variableList[] = {
    ...
    new ProcessorStats_Battery(&mcuBoard, "b17cb0f2-5538-4790-8641-39f416d185a3"),
