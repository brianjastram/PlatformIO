...
// #include <AM2315C.h>
#include "/Users/brianjastram/Documents/PlatformIO/Projects/GreenHouse/.pio/libdeps/mayfly/AM2315C/AM2315c.h"
/** End [includes] */
...
TwoWire* myI2C = &Wire;
int8_t powerPin = AM2315Power;
uint8_t measurementsToAverage = 3;  // or any other value you want
AM2315C am2315(myI2C);
// Create humidity and temperature variable pointers for the AM2315
Variable* am2315Humid =
    new AM2315C_Humidity(&am2315, "0af7a334-7200-4ade-853d-09c66afb6f58");
Variable* am2315Temp =
    new AM2315C_Temperature(&am2315, "5c5f2d60-497c-4c34-b6fb-6c074a56b200");
/** End [ao_song_am2315] */
...
Variable *variableList[] = {
    ...
    new AM2315C_Temperature(&am2315),               // Temperature (AOSong_AM2315_Temp)
    new AM2315C_Humidity(&am2315)            // Relative humidity (AOSong_AM2315_Humidity)
};
...
// Initialize the AM2315 sensor
    if (!am2315.begin()) {
        Serial.println("AM2315 sensor initialization failed!");
    } else {
        Serial.println("AM2315 sensor initialized successfully!");
    }
