...
const char* sketchName = "GHWX.cpp";
// Logger ID, also becomes the prefix for the name of the data file on SD card
const char *LoggerID = "GHX2";
...
/// ==========================================================================
//  AOSong AM2315C Digital Humidity and Temperature Sensor
// ==========================================================================
/** Start [ao_song_am2315c] */
...
Variable *variableList[] = {
    new ProcessorStats_Battery(&mcuBoard, "uuid1"),       // Battery voltage (ProcessorStats_Battery)
    new Modem_SignalPercent(&modem, "uuid3"),             // Percent full scale (EnviroDIY_LTEB_SignalPercent)
    new AOSongAM2315_Humidity(&am2315, "uuid5"),              // Temperature (TemperatureVariable)
    new AOSongAM2315_Temp(&am2315, "uuid6"),           // Relative humidity (HumidityVariable)
};
