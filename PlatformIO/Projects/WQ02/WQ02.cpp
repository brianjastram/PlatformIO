...
Variable* variableList[] = {
    ...
    new Modem_RSSI(&modem),                      // Received signal strength indication (EnviroDIY_LTEB_RSSI)
...
{
    "12329c1f-1dc9-4e29-9840-cde8ed7479ec",   // Water depth (Meter_Hydros21_Depth)
    "74184ee7-717d-46c5-98d8-a7efdd4a53ff",   // Temperature (Meter_Hydros21_Temp)
    "0372d16a-cee4-4184-baa2-ebde6c5df534",   // Specific conductance (Meter_Hydros21_Cond)
    "181a75b3-14fe-4355-aedc-653e8196fe12",   // Relative humidity (Sensirion_SHT40_Humidity)
    "c5169d75-05b5-4bd8-b5a0-26f4eec35e93",   // Temperature (Sensirion_SHT40_Temperature)
    "ea8b0f18-a09c-4143-a498-f569f7b35187",   // Temperature (Maxim_DS3231_Temp)
    "253b68a6-3d33-48b7-ad50-ceff1407ab47",   // Received signal strength indication (EnviroDIY_LTEB_RSSI)
    "65ef90cc-70c4-4e7a-966b-55f88a8e5acc",   // Percent full scale (EnviroDIY_LTEB_SignalPercent)
    "a4f5ea06-04dd-4f21-979b-24f083cff297"    // Battery voltage (EnviroDIY_Mayfly_Batt)
};
const char *registrationToken = "69361487-3012-4ba3-9514-d8d3d0f12c81";   // Device registration token
const char *samplingFeature = "f79eb168-6922-476b-94a9-50a70486ad56";     // Sampling feature UUID
